...
if ($password != null){
    ...
    $txt = "Question verification...";

    if ($question != "1" && $question != "2"){
        $passdata[] = "Invalid question selected";
        $txt = $txt."FAILED\n";
        $errors += 1;
    }
    else
    ...
    fwrite($myfile, $txt);
    $txt = "Answer verification...";

    if (sizeof($answer) > "10"){
        $passdata[] = "Invalid answer. Answer must be less than 10 characters";
        $txt = $txt."FAILED\n";
        $errors += 1;
    }
    else
    ...
    */
    ...
    if ($errors == 0){
        ...
        $stmt = $pdo->prepare("INSERT INTO users (ID, username, password, accessLevel) VALUES (NULL, ?, ?, 0);");
